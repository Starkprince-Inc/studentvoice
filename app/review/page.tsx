...
export default async function ReviewPage() {
  ...
  return <><SiteHeader /><main className="review-workspace"><header className="page-hero shell review-hero"><p className="eyebrow"><span className="live-dot" /> Protected reviewer workspace</p><h1>Evidence control.</h1><p className="lede">Review every private derivative, map adjacent frames to an anonymous subject, dismiss false leads, and record documentary identity evidence without creating a public name.</p><div className="case-header-meta"><span className="meta-chip">SIGNED IN: {user.email}</span><span className="meta-chip">FRAME ACCESS: PRIVATE</span><span className="meta-chip">NO BIOMETRIC MATCHING</span></div></header><ReviewControl /></main></>;
}
